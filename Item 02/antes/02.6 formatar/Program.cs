...
namespace _02._6_formatar
{
    class Program
    {
        private const string Format = @"                                             CONTRATO INDIVIDUAL DE TRABALHO TEMPORÁRIO
...
Cláusula 1ª - O EMPREGADO prestará ao EMPREGADOR, a partir de {2:d} e assinatura deste instrumento, seus trabalhos exercendo a função de {3}, prestando pessoalmente o labor diário no período compreendido entre {4:t} e {4:t}, e intervalo de 1 hora para almoço;
...
(Nome, R.G, Testemunha)
 ";
        ...
        static void Main(string[] args)
        {
            ...
            string documento =
                string.Format(
                Format, contrato.Empresa, contrato.Funcionario, contrato.Inicio, contrato.Cargo, contrato.Salario, DateTime.Today);
